...
<section class="about-flow impact-flow">
  ...
  <div class="about-block align-right">
    <p class="about-kicker">Why It Matters</p>
    <h2>Every performance has a purpose.</h2>
    <p>
      Our goal is to make music feel meaningful beyond the rehearsal room. By connecting performances with charitable giving, we hope to create events where students can enjoy music, build community, and contribute to causes that matter.
    </p>
  </div>
